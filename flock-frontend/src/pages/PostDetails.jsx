...
const PostDetails = () => {
  ...
  if (postNotFound || (postError && postError.includes("not found"))) {
    return (
      <>
        <style>{`
        ...
        >
          ...
          >
            This post may have been deleted or it never existed.
          </div>
          <button
            onClick={() => navigate("/")}
            style={{
  ...
  return (
    <>
      ...
      {isAuthenticated && post && !postError && !postNotFound ? (
        <div
          style={{
            padding: "1rem 1.25rem",
            borderBottom: "1px solid var(--border)",
      ...
      {isAuthenticated && !post && !isLoadingPost && !postError && !postNotFound
        ? null
        : null}
